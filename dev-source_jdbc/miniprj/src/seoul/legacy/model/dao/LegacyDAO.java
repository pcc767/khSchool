...
public class LegacyDAO {
	...
	public List<Legacy> selectByLegacyArea(Connection conn, String area) {
		...
		try {
			...
			String sql = "select legacy_design_no, legacy_trans_no, legacy_no, legacy_name_kor, legacy_category_name, legacy_address, "
					+ "legacy_name_chi, legacy_area, legacy_admin, legacy_type, legacy_type2, legacy_type3, legacy_type4, "
					+ "legacy_quantity, legacy_era, legacy_owner, legacy_enrolldate, legacy_longitude, legacy_latitude, legacy_content "
					+ "from tbl_legacy where legacy_area like ?";
			...
			while (rs.next()) {
				...
				String legacy_design_no = rs.getString("legacy_design_no");
				String legacy_trans_no = rs.getString("legacy_trans_no");
				int legacy_no = rs.getInt("legacy_no");
				String legacy_name_kor = rs.getString("legacy_name_kor");
				String legacy_category_name = rs.getString("legacy_category_name");
				String legacy_adress = rs.getString("legacy_address");
				String legacy_name_chi = rs.getString("legacy_name_chi");
				String legacy_area = rs.getString("legacy_area");
				String legacy_admin = rs.getString("legacy_admin");
				String legacy_type = rs.getString("legacy_type");
				String legacy_type2 = rs.getString("legacy_type2");
				String legacy_type3 = rs.getString("legacy_type3");
				String legacy_type4 = rs.getString("legacy_type4");
				String legacy_quantity = rs.getString("legacy_quantity");
				String legacy_era = rs.getString("legacy_era");
				String legacy_owner = rs.getString("legacy_owner");
				String legacy_enrolldate = rs.getString("legacy_enrolldate");
				String legacy_longitude = rs.getString("legacy_longitude");
				String legacy_latitude = rs.getString("legacy_latitude");
				String legacy_content = rs.getString("legacy_content");

				temp.add(new Legacy(legacy_no, legacy_design_no, legacy_trans_no, legacy_category_name, legacy_name_kor,
						legacy_name_chi, legacy_area, legacy_adress, legacy_admin, legacy_type, legacy_type2,
						legacy_type3, legacy_type4, legacy_quantity, legacy_era, legacy_owner, legacy_content,
	...
	public int insert(Connection conn, Legacy legacy) {
		try {
			String sql = "INSERT INTO "
					...
					+ "			LEGACY_LONGITUDE, LEGACY_LATITUDE) " + "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, "
					+ "		?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public Legacy selectOneByNo(Connection conn, int no) {
		Legacy temp = null;
		...
		try {
			String sql = "select * from tbl_legacy where legacy_no = ?";
			...
			while (rs.next()) {
				...
				temp = new Legacy(legacy_no, legacy_design_no, legacy_trans_no, legacy_category_name, legacy_name_kor,
						legacy_name_chi, legacy_area, legacy_address, legacy_admin, legacy_type, legacy_type2,
						legacy_type3, legacy_type4, legacy_quantity, legacy_era, legacy_owner, legacy_content,
						legacy_enrolldate, legacy_longitude, legacy_latitude);
