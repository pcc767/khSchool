...
public class Legacy {
	...
	private String legacy_enrolldate;
	...
	public Legacy(int legacy_no, String legacy_design_no, String legacy_trans_no, String legacy_category_name,
			...
			String legacy_enrolldate, String legacy_longitude, String legacy_latitude) {
		super();
	...
	public String toString() {// 수정
		return "문화재명 : " + legacy_name_kor + "\n종목 : " + legacy_category_name + "\n지역 : " + legacy_area + "\n시대 : "
				+ legacy_era;
	}

	public String detailToString() { // 추가
		return "문화재명(한글) : " + legacy_name_kor + "\n문화재명(한자) : " + legacy_name_chi + "\n종목 : " + legacy_category_name
				+ "\n분류 : " + legacy_type + ", " + legacy_type2 + ", " + legacy_type3 + ", " + legacy_type4 + "\n소재지 : "
				+ legacy_address + "\n수량 : " + legacy_quantity + "\n시대 : " + legacy_era + "\n설명 : " + legacy_content;
	}

	public int getLegacy_no() {
		return legacy_no;
	}

	public void setLegacy_no(int legacy_no) {
		this.legacy_no = legacy_no;
	}
	...
	public String getLegacy_enrolldate() {
		return legacy_enrolldate;
	}

	public void setLegacy_enrolldate(String legacy_enrolldate) {
		this.legacy_enrolldate = legacy_enrolldate;
	}
