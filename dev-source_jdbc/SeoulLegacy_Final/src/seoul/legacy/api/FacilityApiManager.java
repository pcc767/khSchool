...
public class FacilityApiManager {
...
//				System.out.println("\n=======================================\n");
				if (nodeList.getNodeType() == Node.ELEMENT_NODE) {
					...
					Facility palace = new Facility(p_facility_no, palace_no, p_facility_detail_no, p_facility_name_kor,
					...
					list.add(palace);
//					System.out.println(palace.toString().replace(", ", ",\n"));
				}
			}
			connList.disconnect();
