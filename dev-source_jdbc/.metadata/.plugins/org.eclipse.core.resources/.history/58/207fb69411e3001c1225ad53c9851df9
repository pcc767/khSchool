...
public class Palace {
    ...
    private String gung_name;	            // String	궁 이름
    private int p_facility_detail_no;       // int detail_code 세부코드
    private String contents_kor;            // String	문화재명
    private String explanation_kor;	        // String	문화재 설명
...
//    private String imgUrl;	                // String	문화재 이미지 경로          // Header_data 중복
    ...
    public Palace(int facility_no, int castle_no, int p_facility_detail_no, String contents_kor,
                  String explanation_kor, String imgUrl) {
    ...
    public String getGung_name() {
        return gung_name;
    }

    public void setGung_name(String gung_name) {
        this.gung_name = gung_name;
    }
    ...
    public String toString() {
        return "Palace{" +
                ...
                ", castle_no=" + castle_no +
                ", gung_name='" + gung_name + '\'' +
                ", p_facility_detail_no=" + p_facility_detail_no +
                ", contents_kor='" + contents_kor + '\'' +
                ", explanation_kor='" + explanation_kor + '\'' +
                ", imgUrl='" + imgUrl + '\'' +
                ", p_facility_name_eng='" + p_facility_name_eng + '\'' +
                ", p_facility_name_jpa='" + p_facility_name_jpa + '\'' +
                ", p_facility_name_chi='" + p_facility_name_chi + '\'' +
                ", p_facility_content_eng='" + p_facility_content_eng + '\'' +
                ", p_facility_content_jpa='" + p_facility_content_jpa + '\'' +
